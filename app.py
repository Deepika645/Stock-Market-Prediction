...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        ...
        ''',"https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c3RvY2slMjBtYXJrZXR8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80", "About ", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
